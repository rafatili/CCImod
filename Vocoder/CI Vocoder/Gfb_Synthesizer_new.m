...
%
% PARAMETERS:
% analyzer                  an analyzer struct as returned by
%                           Gfb_Synthesizer_new
%                           Several pluggable analyzers may be given as a
%                           structure array.
...
desired_delay_in_samples = round(desired_delay_in_seconds * ...
			         analyzer(1).sampling_frequency_hz);
if (desired_delay_in_samples < 1)
    error('delay must be at least 1/analyzer(1).sampling_frequency_hz');
end
