...
%     CI_center_frequencies(filters_per_ERBaud, ...
% 			   lower_cutoff_frequency_hz,     ...
% 			   specified_center_frequency_hz, ...
% 			   upper_cutoff_frequency_hz);

%**************************************************************************
%                      1st choice of center frequencies(12 filters):           
%analyzer.center_frequencies_hz = [348 460 608 803 1062 1403 1853 2449 3236 4276 5650 7466];

%**************************************************************************
%              STRATEGIES of MEDELimplants: HDCIS vs. CSSS
%constructs the center frequencies of the MED-EL-implant (12 filters) optional:
%*************************************************************************
%1)strategy: HDCIS or CSSS, tonotopic, 70Hz-8500Hz
%analyzer.center_frequencies_hz = [159 343 539 757 1010 1318 1712 2244 2990 4039 5459 7383];
%!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
%2)strategy: HDCIS or CSSS, logarithmic, 70Hz-8500Hz
analyzer.center_frequencies_hz = center_frequencies_hz; %[120 235 384 579 836 1175 1624 2222 3019 4084 5507 7410];
%**************************************************************************
%3)strategy: HDCIS or CSSS, ...
%...
%**************************************************************************
