function [stimuli, NRgains] = mod_stimulateGT_NR_NH( mix, speech, noise , map, tech, plotflag )
...
if (isfield(map,'Left') ==1)
    ...
    stimuli = ufscACEprocessGT_NR_NH(mix, map.Left, NRgains.left, plotflag);
end
...
if (isfield(map,'Right') ==1)
    ...
    stimuli = ufscACEprocessGT_NR_NH(mix, map.Right, NRgains.right, plotflag);
end
