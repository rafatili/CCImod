...
% These are the Princen-Bradley conditions [3].
%
...
%   kaiser(5)  boqD2    2           -23dB     1.2      1.7      1.3 used in AAC [2]
...
%  [1]  F. J. Harris. On the use of windows for harmonic analysis with the
%       discrete fourier transform. Proc IEEE, 66 (1): 51–83, Jan. 1978.
%  [2]	T. Sporer, K. Brandenburg, and B. Edler.
%       The use of multirate filter banks for coding of high quality digital audio.
%       In Proc EUSIPCO, volume 1, pages 211–214, 1992.
%  [3]  J. Princen and A. Bradley. Analysis/synthesis filter bank design based
%       on time domain aliasing cancellation.
%       IEEE Trans. Acoustics, Speech and Signal Processing, 34 (5): 1153–1161,
%       1986. doi: 10.1109/TASSP.1986.1164954.

%      Copyright (C) Mike Brookes 2002-2015
%      Version: $Id: v_windows.m 6801 2015-09-12 09:30:42Z dmb $
%
