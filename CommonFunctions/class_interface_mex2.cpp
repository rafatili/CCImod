// mex file para controle da interface através do linux
// o objetivo é gerar um arquivo .mexa64 para que esta classe funcione em ambiente linux
// investigar como fazer esta adaptação

#include "mex.h"
#include "class_handle.hpp"

#include <windows.h> //encontrar equivalente em linux para esta biblioteca
using namespace std;
#include <iostream>
